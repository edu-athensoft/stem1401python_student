...
print(strtemp3b.format(qty_item1, item1, price_item1, total_item1))
print(strtemp3d.format(''))
print(strtemp3b.format(qty_item2, item2, price_item2, total_item2))
print(strtemp3d.format(''))
print(strtemp3b.format(qty_item3, item3, price_item3, total_item3))
print(strtemp3d.format(''))
