...
if option_1 == 1:
    ...
    if option_2 == 1.0:
        kilometers = int(input("Please enter a Kilometers to convert to Miles: "))
    ...
    if option_2 == 1.0:
        celsius = int(input("Please enter a degree Celsius to convert to Fahrenheit: "))
    ...
    if option_2 == 1.0:
        kilogram = int(input("Please enter a Kilograms to convert to Pounds: "))
        print(f"{kilogram} kilograms = {kilogram_to_pound(kilogram)} pounds")

    elif option_2 == 2.0:
        pound = int(input("Please enter a Pounds to convert to Kilograms: "))
    ...
    if option_2 == 1.0:
        ...
        yuan = int(input("Please enter a Chinese Yuan to convert to Canadian Dollars: "))
