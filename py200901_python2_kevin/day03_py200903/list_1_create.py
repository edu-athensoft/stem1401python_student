...
list is linear structure

list is ordered
list is mutable (changeable)

list can contains difference data type of items
list can contains duplicated items
...
scores = [80,96,75,63,59]
profile_stu1 = ['20190901001','Peter','G8',14,80]
