...
Label(root,text="The First",bg="green",fg='white').grid(row=0,column=0,rowspan=2,columnspan=2,sticky="sew")
# Label(root,text="The Second",bg="blue",fg='white').grid(row=0,column=2,columnspan=2,sticky="e")
Label(root,text="The Second",bg="blue",fg='white').grid(row=0,column=2,columnspan=2,sticky="we")
