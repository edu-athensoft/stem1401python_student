...
# item data
item1 = [1,'Front and rear brake cables',100.0,100.0]
item2 = [2, 'New set of pedal arms',15.0,30.0]
item3 = [3, 'Labor 3hrs', 5.0, 15.0]

subtotal = item1[3] + item2[3] + item3[3]
TAX_RATE = 6.25*0.01
...
line2 = template3b.format(item1[0], item1[1], item1[2], item1[3])
line3 = template3b.format(item2[0], item2[1], item2[2], item2[3])
line4 = template3b.format(item3[0], item3[1], item3[2], item3[3])
