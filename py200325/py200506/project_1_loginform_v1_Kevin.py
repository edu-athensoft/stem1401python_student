...
print("Hello, your username for your Bas card Montreal account is {}, and your password is {}!".format(username, password))

# The program ends with "Goodbye!"
print("Thank you for create your account of Bus card Montreal, Goodbye!")
